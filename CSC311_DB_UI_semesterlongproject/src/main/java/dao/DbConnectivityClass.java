...
public class DbConnectivityClass {
    final static String DB_NAME="gfgfg555";
        MyLogger lg= new MyLogger();
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311111cccccc.mariadb.database.azure.com/";
        final static String DB_URL = "jdbc:mysql://csc311111cccccc.mariadb.database.azure.com/"+DB_NAME;
        final static String USERNAME = "adminshahin@csc311111cccccc";
        final static String PASSWORD = "farmingdale$123";
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, USERNAME, PASSWORD)) {
            ...
            if (rowsAffected > 0) {
                ...
                if (generatedKeys.next()) {
                    ...
                    lg.makeLog("A new user was inserted successfully with ID: " + generatedId);
                    person.setId(generatedId); // Set the generated ID in the Person object
                }
            } else {
                lg.makeLog("Insertion failed. No rows were affected.");
            }
        ...
        public int retrieveId(Person p) {
            ...
            try (Connection conn = DriverManager.getConnection(DB_URL, USERNAME, PASSWORD)) {
                ...
                if (resultSet.next()) {
                    ...
                    lg.makeLog("No ID found for email: " + p.getEmail());
                }
